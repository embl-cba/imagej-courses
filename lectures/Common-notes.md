Lecture materials are edited in `.md` files and produce automatically html files using [`markdown-to-slides`](https://www.npmjs.com/package/markdown-to-slides) package
